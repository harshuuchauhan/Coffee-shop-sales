...
This project analyzes **Coffee Shop sales performance** using an interactive Power BI dashboard. It provides insights into revenue trends, best‑selling products, category contributions, store-wise performance, and customer purchasing behavior. The dashboard transforms raw transaction data into decision‑ready insights to support operational planning, marketing strategy, and business growth.
